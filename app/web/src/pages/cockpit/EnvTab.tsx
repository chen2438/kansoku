      ...
      {position && (
        <>
          ...
          <div className="grid2">
            ...
            <div className="v">${priceStr(position.cost, priceDecimals(position.cost, isCryptoSymbol(position.symbol)))}</div>
            <div className="k">现价</div>
            <div className="v">${priceStr(position.last, priceDecimals(position.last, isCryptoSymbol(position.symbol)))}</div>
